 ...
 * Time: 4:08 PM
 */
public class InLinkGraphGenerator {
    ...
    public InLinkGraphGenerator(String input, String output) throws IOException {
        Configuration config = new Configuration();
        config.set("xmlinput.start", "<page>");
        config.set("xmlinput.end", "</page>");

        job = new Job(new Configuration(), "InLinkGraphGenerator");

        job.setJarByClass(InLinkGraphGenerator.class);
